# Feature Issues für HeatControl-Übernahme

Diese Datei enthält alle 10 Feature-Request-Issues zum Kopieren. Du kannst sie manuell unter https://github.com/BubTec/DPVControl/issues/new anlegen.

**Plan:** Siehe [heatcontrol_features_plan.md](heatcontrol_features_plan.md) für Kontext, Abhängigkeiten und Risikoanalyse.

**Alternative:** GitHub CLI installieren (`winget install GitHub.cli`), dann `gh auth login` und danach:
```powershell
.\.github\create_feature_issues.ps1
```

---

## Issue 1: Verzögerter Neustart
...
## Issue 5: Erweiterte Captive-Portal-URLs
...
- [ ] Log-level control (or links to Issue 4)
...
## Issue 7: Client-Zugriffskontrolle
...
- **Issue 6** hängt von **Issue 3** ab – zuerst Issue 3 anlegen, dann bei Issue 6 „Depends on #XX“ mit der Issue-Nummer ergänzen.
